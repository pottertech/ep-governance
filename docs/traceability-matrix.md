...
| Resource canonicalization | v1.1.1 (additional corrections) | Policies match canonical resource identities (e.g., postgres://cloudhub/gbrain_pilot/public/memory_items), not raw agent-supplied strings. | classify.py (resource canonicalization), policy.py (resource matching) | 2 | Planned |
